...
struct L10n {
    ...
    var chatCelestia: String { s("✧ Celestia", "✧ Celestia", "✧ Celestia", "✧ セレスティア", "✧ 셀레스티아", "✧ Celestia", "✧ सेलेस्टिया", "✧ Celestia", "✧ Celestia", "✧ Celestia") }
    ...
    var askCelestia: String { s("Ask Celestia...", "Pregunta a Celestia...", "Pergunte a Celestia...", "セレスティアに聞く...", "셀레스티아에게 물어보세요...", "Demandez à Celestia...", "सेलेस्टिया से पूछें...", "Frage Celestia...", "詢問Celestia...", "询问Celestia...") }
    ...
    var celestiaInterpretation: String { s("Celestia's Interpretation", "Interpretación de Celestia", "Interpretação de Celestia", "セレスティアの解釈", "셀레스티아의 해석", "Interprétation de Celestia", "सेलेस्टिया की व्याख्या", "Celestias Deutung", "Celestia的解讀", "Celestia的解读") }
    ...
    var celestiaReading: String { s("Celestia's Reading", "Lectura de Celestia", "Leitura de Celestia", "セレスティアのリーディング", "셀레스티아의 리딩", "Lecture de Celestia", "सेलेस्टिया का पठन", "Celestias Lesung", "Celestia的解讀", "Celestia的解读") }
    ...
    var inviteFriends: String { s("Invite Friends to Celestia", "Invita Amigos a Celestia", "Convide Amigos para Celestia", "友達をCelestiaに招待", "친구를 Celestia에 초대", "Invitez des Amis sur Celestia", "दोस्तों को Celestia पर आमंत्रित करें", "Lade Freunde zu Celestia Ein", "邀請朋友加入Celestia", "邀请朋友加入Celestia") }
    ...
    var inviteEarn: String { s("Invite a friend to Celestia and you both earn 15 ✦", "Invita a un amigo a Celestia y ambos ganan 15 ✦", "Convide um amigo para Celestia e ambos ganham 15 ✦", "友達をCelestiaに招待すると、二人とも15 ✦獲得", "친구를 Celestia에 초대하면 둘 다 15 ✦ 획득", "Invitez un ami sur Celestia et gagnez tous les deux 15 ✦", "मित्र को Celestia पर आमंत्रित करें, दोनों 15 ✦ कमाएं", "Lade einen Freund zu Celestia ein und verdient beide 15 ✦", "邀請好友加入Celestia，雙方各獲得15 ✦", "邀请好友加入Celestia，双方各获得15 ✦") }
